...
// source: carpcomm/pb/telemetry.proto
// DO NOT EDIT!
...
type TelemetryDatumSchema struct {
	...
	Type             *TelemetryDatumSchema_Type `protobuf:"varint,2,opt,name=type,enum=pb.TelemetryDatumSchema_Type" json:"type,omitempty"`
	Unit             *TelemetryDatumSchema_Unit `protobuf:"varint,3,opt,name=unit,enum=pb.TelemetryDatumSchema_Unit" json:"unit,omitempty"`
...
func init() {
	proto.RegisterEnum("pb.TelemetryDatumSchema_Type", TelemetryDatumSchema_Type_name, TelemetryDatumSchema_Type_value)
	proto.RegisterEnum("pb.TelemetryDatumSchema_Unit", TelemetryDatumSchema_Unit_name, TelemetryDatumSchema_Unit_value)
}
